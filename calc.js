...
if (x < 10000 || x > 100000) {
    output.textContent = "Loan amount must be between 10,000 and 100,000.";
    return;
}

if (y < 10 || y > 1000) {
    output.textContent = "duration amount must be between 10 and 1,000.";
    return;
}

if (z < 1000 || z > 50000) {
    output.textContent = "saary amount must be between 1,000 and 50,000.";
    return;
}
if(selected){
